    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/sleep" element={<Sleep {...props} />}>
            {" "}
          </Route>
          <Route path="/nutrition" element={<Nutrition {...props} />}>
            {" "}
          </Route>
          <Route path="/exercise/*" element={<Exercise {...props} />}>
            {" "}
          </Route>
          <Route path="/activity" element={<Activity {...props} />}>
            {" "}
          </Route>
        </Routes>
        {/* <Info /> */}
